---
title: "第11章: 10グループの表情記号"
description: "手話の文法に欠かせない非手指動作（NMM）を司る、額から顎まで10個の表情カテゴリ記号を徹底解説します。"
---

手話において、顔の表情や頭部の動きは単なる感情表現ではなく、疑問文、否定文、強調などの**「文法機能」**を担う極めて重要な言語要素（非手指動作：NMM）です。

SignWritingでは、表情を**10個の部位カテゴリ**に分けて厳密に記述します。

---

## 表情記号の10個のカテゴリ (The 10 Groups of Facial Expressions)
  ...
  <div style="display: flex; gap: 1.5rem; align-items: flex-start; border-bottom: 1px solid rgba(255, 255, 255, 0.08); padding-bottom: 1rem; flex-wrap: wrap;">
    ...
    <div style="flex: 1; min-width: 250px;">
      <p style="margin: 0; font-size: 0.95rem; line-height: 1.6;">
        手話文法で最重要のパーツです。<br/>
        * **眉を上げる** <fsw-symbol symbol="S2e500" style="transform:scale(0.9); margin:0;"></fsw-symbol>：Yes/No疑問文、主題提示。<br/>
        * **眉をひそめる** <fsw-symbol symbol="S2e510" style="transform:scale(0.9); margin:0;"></fsw-symbol>：WH疑問文（何、誰、どこ等）、否定。
      </p>
    </div>
  </div>
  ...
  <div style="display: flex; gap: 1.5rem; align-items: flex-start; border-bottom: 1px solid rgba(255, 255, 255, 0.08); padding-bottom: 1rem; flex-wrap: wrap;">
    ...
    <div style="flex: 1; min-width: 250px;">
      <p style="margin: 0; font-size: 0.95rem; line-height: 1.6;">
        ...
        * **微笑む** <fsw-symbol symbol="S2e700" style="transform:scale(0.9); margin:0;"></fsw-symbol>：肯定的・穏やか。<br/>
        * **口を丸くすぼめる** <fsw-symbol symbol="S2e730" style="transform:scale(0.9); margin:0;"></fsw-symbol>：丁寧、または「う」の口型。<br/>
        * **口を大きく開ける** <fsw-symbol symbol="S2e710" style="transform:scale(0.9); margin:0;"></fsw-symbol>：驚き・肯定。
      </p>
    </div>
  </div>
...
1. **表情＝文法**：手話における顔の役割は非常に大きく、眉や口元の記号は文構造そのものを定義します。
2. **頭部円の中へのレイアウト**：これら10個の表情カテゴリのパーツは、第1章で学んだ「頭部円」の中に透視構図で美しく配置されます。
